...
@section('js_after')
    ...
    <!-- Page JS Code -->
    <script src="{{ asset('js/master/kategoriinvestigasi.js') }}"></script>
    <script>
        $.ajaxSetup({
            headers: {
    ...
    <script type="text/javascript">
        $('.js-dataTable-buttons').dataTable({
            ...
            ajax: '{{ url("kategoriinvestigasi") }}',
            columns: [
                {data: 'DT_RowIndex' , name: 'id', width: '5%'},
                {data: 'kategori_investigasi', name: 'kategori_investigasi', width: '25%'},
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                <div class="flex-grow-1">
                    ...
                    <h2 class="fs-base lh-base fw-medium text-muted mb-0">
                        Master Data Kategori Investigasi
                    </h2>
                </div>
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">
                    LIST DATA KATEGORI INVESTIGASI
                </h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="block block-rounded block-transparent mb-0">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Tambah data kategori investigasi</h3>
                    ...
                    <div class="block-content fs-sm">
                        ...
                        <div class="form-floating mb-4">
                            <input required="" autocomplete="off" type="text" class="form-control" id="kategori_investigasi" name="kategori_investigasi" placeholder="Jenis klaim">
                            <label for="example-text-input-floating">Kategori Investigasi</label>
                        </div>
                        <div class="form-floating mb-4">
                ...
                <div class="block block-rounded block-transparent mb-0">
                    ...
                    <div class="block-content fs-sm">
                        ...
                        <div class="form-floating mb-4">
                            ...
                            <input required="" autocomplete="off" type="" class="form-control" id="editkategori_investigasi" name="kategori_investigasi" placeholder="Jenis klaim">
                            <label for="example-text-input-floating">Kategori Investigasi</label>
                        </div>
                        <div class="form-floating mb-4">
