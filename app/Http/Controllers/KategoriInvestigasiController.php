...
class KategoriInvestigasiController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = KategoriInvestigasi::select('*')->orderBy('created_at','DESC');
        ...
        return view('master.kategoriinvestigasi');
    }
    ...
    {
        KategoriInvestigasi::create($request->all());
    }
    ...
    public function edit($id)
    {
        if(request()->ajax())
        {
            $data = KategoriInvestigasi::findOrFail($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, KategoriInvestigasi $kategoriinvestigasi)
    {
        $kategoriinvestigasi->update($request->all());
    }
    ...
    {
        KategoriInvestigasi::find($id)->delete();
    }
}
